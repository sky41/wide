...
# 调用人脸分类器，要根据实际路径调整3
face_detector = cv2.CascadeClassifier(r'D:/python/Scripts/opencv/build/etc/haarcascades/haarcascade_frontalface_default.xml')  # 待更改
# 为即将录入的脸标记一个id
...
# 调用熟悉的人脸分类器
detector = cv2.CascadeClassifier('D:/python/Scripts/opencv/build/etc/haarcascades/haarcascade_frontalface_default.xml')
