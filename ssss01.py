...
# data = pd.read_excel('附件_一季度.xlsx', 'Sheet1', index_col=0)
# data.to_csv('附件_一季度0001.csv', encoding='utf-8')
data1 = pd.read_csv('附件_一季度0001.csv')
# data = pd.read_excel('附件_二季度.xlsx', 'Sheet1', index_col=0)
# data.to_csv('season2.csv', encoding='utf-8')
data2 = pd.read_csv('附件_一季度0001.csv')
# data = pd.read_excel('附件_三季度.xlsx', 'Sheet1', index_col=0)
# data.to_csv('season3.csv', encoding='utf-8')
data3 = pd.read_csv('附件_一季度0001.csv')
# data = pd.read_excel('附件_四季度.xlsx', 'Sheet1', index_col=0)
# data.to_csv('season4.csv', encoding='utf-8')
